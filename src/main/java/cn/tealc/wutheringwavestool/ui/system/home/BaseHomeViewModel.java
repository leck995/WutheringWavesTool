...
public abstract class BaseHomeViewModel extends BaseViewModel {
    private static final Logger LOG = LoggerFactory.getLogger(BaseHomeViewModel.class);
     ...
     * @date: 2024/10/8
     */
    public List<GameTime> getGameTimes() {
        return gameTimeService.getTodayGameTimes();
    }

    public void updateGameTimeText(long sum) {
