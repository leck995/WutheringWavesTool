...
public class HttpRequestUtil {
    ...
    public static HttpRequest getRequestWithSource(String url,String token,String source) {
        return HttpRequest.newBuilder()
                .uri(URI.create(url))
                .timeout(Duration.ofSeconds(20))
                .header("Content-Type", "application/x-www-form-urlencoded")
    ...
    public static HttpRequest getRequestWithSource(String url,String body,String token,String source) {
        return HttpRequest.newBuilder()
                .uri(URI.create(url))
                .timeout(Duration.ofSeconds(20))
                .header("Content-Type", "application/x-www-form-urlencoded")
